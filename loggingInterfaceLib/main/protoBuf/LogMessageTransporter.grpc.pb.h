...
#ifndef GRPC_LogMessageTransporter_2eproto__INCLUDED
#define GRPC_LogMessageTransporter_2eproto__INCLUDED
...
class LogMessageTransporter final {
 public:
  static constexpr char const* service_full_name() {
    return "logmessagetransporter.LogMessageTransporter";
  }
  class StubInterface {
   public:
  ...
  class WithAsyncMethod_sendLogMessages : public BaseClass {
   ...
   public:
    WithAsyncMethod_sendLogMessages() {
      ::grpc::Service::MarkMethodAsync(0);
    }
    ~WithAsyncMethod_sendLogMessages() override {
  ...
  typedef WithAsyncMethod_sendLogMessages<Service > AsyncService;
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_sendLogMessages : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ...
    ~ExperimentalWithCallbackMethod_sendLogMessages() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status sendLogMessages(::grpc::ServerContext* /*context*/, const ::logmessagetransporter::MessagesRequest* /*request*/, ::logmessagetransporter::AcknowledgeReply* /*response*/) override {
  ...
  template <class BaseClass>
  class WithGenericMethod_sendLogMessages : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_sendLogMessages() {
      ::grpc::Service::MarkMethodGeneric(0);
    }
    ~WithGenericMethod_sendLogMessages() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status sendLogMessages(::grpc::ServerContext* /*context*/, const ::logmessagetransporter::MessagesRequest* /*request*/, ::logmessagetransporter::AcknowledgeReply* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_sendLogMessages : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_sendLogMessages() {
      ::grpc::Service::MarkMethodRaw(0);
    }
    ~WithRawMethod_sendLogMessages() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status sendLogMessages(::grpc::ServerContext* /*context*/, const ::logmessagetransporter::MessagesRequest* /*request*/, ::logmessagetransporter::AcknowledgeReply* /*response*/) override {
    ...
    void RequestsendLogMessages(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(0, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_sendLogMessages : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_sendLogMessages() {
      ::grpc::Service::experimental().MarkMethodRawCallback(0,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->sendLogMessages(context, request, response, controller);
                 }));
    }
    ~ExperimentalWithRawCallbackMethod_sendLogMessages() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status sendLogMessages(::grpc::ServerContext* /*context*/, const ::logmessagetransporter::MessagesRequest* /*request*/, ::logmessagetransporter::AcknowledgeReply* /*response*/) override {
    ...
    virtual void sendLogMessages(::grpc::ServerContext* /*context*/, const ::grpc::ByteBuffer* /*request*/, ::grpc::ByteBuffer* /*response*/, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  class WithStreamedUnaryMethod_sendLogMessages : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
  ...
  typedef WithStreamedUnaryMethod_sendLogMessages<Service > StreamedService;
};

}  // namespace logmessagetransporter


#endif  // GRPC_LogMessageTransporter_2eproto__INCLUDED
